...
class PID:
    ...
    def __init__(self,K_z: list, K_roll: list, K_pitch: list, K_yaw: list, dt:float, tau:float, alpha:float,cam_orientation:float,tolerance:float, index:int ,beta:float) -> None:
        ...
        self.roll_lower    =1475
        self.pitch_lower   =1475
        self.roll_upper    =1525
        self.pitch_upper   =1525
...
if __name__ == '__main__':  
    ...
    plutoPID = PID(K_z,K_roll,K_pitch,K_yaw,dt=0.1,tau=0.06,alpha = 0.5,cam_orientation= 196.0, tolerance=15, index = 0,beta=0.5)
